...
void SetLayoutConstantsFallback() {
  ...
  layout_constant_values[TABSTRIP_TOOLBAR_OVERLAP] = 1;
  ...
  layout_constant_values[NEW_TAB_BUTTON_LEADING_MARGIN] = 0;
  layout_constant_values[STAR_RATING_ICON_SIZE] = 14;
  layout_constant_values[TOOLBAR_HEIGHT_SIDE_PANEL_INSET] = 8;
  layout_constant_values[MAIN_BACKGROUND_REGION_CORNER_RADIUS] = 8;
  layout_constant_values[VERTICAL_TAB_HEIGHT] = 30;
  layout_constant_values[VERTICAL_TAB_STRIP_HORIZONTAL_PADDING] = 12;
  layout_constant_values[VERTICAL_TAB_STRIP_BOTTOM_BUTTON_PADDING] = 4;
}
