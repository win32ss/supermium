...
#define SUPERMIUM_FLAG_ENTRIES_H_
    {"force-dark-mode",
	 "Forced Dark Mode for UI", 
     "Enables dark mode for all UI elements (but not web contents - enable #enable-force-dark for darkening web contents).", kOsAll,
	 FEATURE_VALUE_TYPE(base::features::kForceDarkModeFlag)},
#if BUILDFLAG(IS_WIN)
	{"disable-windows-10-custom-titlebar",
	 "Force disabling of Windows 10 custom titlebar", 
     "Disable the \"Windows 10\" custom titlebar to take advantage of Aero Glass fixes for the operating system.", kOsWin,
	 SINGLE_VALUE_TYPE("disable-windows10-custom-titlebar")},
	{"force-xp-theme",
	 "Use Classic Theme", 
     "Use the classic Chrome theme designed to mimick \"Aero\" window controls. " 
     "Typically used when desktop composition is disabled or unavailable.", kOsWin,
	 FEATURE_VALUE_TYPE(kForceXpTheme)},	 
	{"force-gdi",
	 "Force GDI font rendering", 
     "Use GDI font rendering in place of DirectWrite font rendering on Windows.", kOsWin,
  ...
  /*{"download-bubble", "Enable download bubble",
	...
	{"ungoogled-supermium",
     ...
     "Blocks all involuntary connections to Alphabet\\Google.", 
